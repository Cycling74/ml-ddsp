...
struct TORCH_API _histogramdd_bin_edges {
  using schema = ::std::vector<at::Tensor> (const at::Tensor &, at::IntArrayRef, c10::optional<at::ArrayRef<double>>, const c10::optional<at::Tensor> &, bool);
  ...
  static ::std::vector<at::Tensor> call(const at::Tensor & self, at::IntArrayRef bins, c10::optional<at::ArrayRef<double>> range, const c10::optional<at::Tensor> & weight, bool density);
